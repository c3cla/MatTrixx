...
const EstadisticaEstudiante = ({ estudiante }) => {
  ...
  return (
    <div className="dashboard-docente">
      ...
      <div className="tabla-estudiante-contenedor">
        <div className="tabla-estudiante-tarjeta">
          <h4>Detalle por Pregunta</h4>
          <table className="tabla-estudiante-detalle">
            <thead>
              <tr>
                <th>Etapa</th>
                <th>OA</th>
...
export default EstadisticaEstudiante;
